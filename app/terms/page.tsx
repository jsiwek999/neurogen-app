    ...
    <div className="card space-y-4">
      ...
      <section className="space-y-2">
        ...
        <p className="text-sm" style={{opacity:.9}}>
          By using NEUROGEN (the “Service”), you agree to these Terms. If you
      ...
      <section className="space-y-2">
        ...
        <p className="text-sm" style={{opacity:.9}}>
          ...
          your region) to use the Service.
        </p>
      </section>
      ...
      <section className="space-y-2">
        ...
        <p className="text-sm" style={{opacity:.9}}>
          We currently sell subscriptions via Stripe Checkout or Payment Links.
          Prices (e.g., $4.99/month) are shown before purchase. By subscribing,
          you authorize recurring charges until you cancel. Stripe handles your
          payment information; we don’t store full card details.
        </p>
        <p className="text-sm" style={{opacity:.9}}>
          You can cancel at any time to stop future renewals. Unless required by
      ...
      <section className="space-y-2">
        ...
        <p className="text-sm" style={{opacity:.9}}>
          Don’t break the law, don’t abuse the Service, don’t attempt to bypass
          limits, and don’t harm others. We may suspend or terminate accounts
          for violations.
        </p>
      </section>
      ...
      <section className="space-y-2">
        ...
        <p className="text-sm" style={{opacity:.9}}>
          The Service, its content, and underlying technology are owned by {COMPANY}
          or our licensors. You get a personal, non-transferable license to use
          the Service. Feedback you provide may be used to improve the Service.
        </p>
      </section>
      ...
      <section className="space-y-2">
        ...
        <p className="text-sm" style={{opacity:.9}}>
          Outputs may be imperfect or unsuitable for certain situations. Use your
          own judgment. The Service is not medical or mental-health advice and is
          provided for informational/reflective purposes only.
        </p>
      </section>
      ...
      <section className="space-y-2">
        ...
        <p className="text-sm" style={{opacity:.9}}>
          ...
          Our total liability for any claim is limited to the amount you paid to
          us in the 3 months preceding the event giving rise to the claim.
        </p>
      </section>
      ...
      <section className="space-y-2">
        ...
        <p className="text-sm" style={{opacity:.9}}>
          ...
          access if you violate these Terms or pose risk to the Service or others.
        </p>
      </section>
      ...
      <section className="space-y-2">
        ...
        <p className="text-sm" style={{opacity:.9}}>
          ...
          its conflict of laws rules. Courts located in [Your Venue] have exclusive
          jurisdiction. (Replace this with your actual jurisdiction/venue.)
        </p>
      </section>
